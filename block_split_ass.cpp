...
void print_meta_block_stats(block_meta_data_t *first_block_meta_data);
...
static void print_one_meta_block_stats(block_meta_data_t *block_meta_data){
...
static void print_all_meta_blocks(block_meta_data_t *first_meta_block){


    while(first_meta_block){

        print_one_meta_block_stats(first_meta_block);
